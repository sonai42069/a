...
const PatientCard = ({ patient, isExpanded, onClick, onEdit }) => {
    ...
    return (
        <div className={`patient-visit-card ${isExpanded ? "expanded" : ""}`}>
            {!isExpanded && <div className="time">{patient.slot_start_time}</div>}
            {isExpanded && (
                <div className="patient-visit-card-header">
                    <input
                        type="text"
            ...
            <table className="patient-visit-card-table">
                <tbody>
                {!isExpanded && (
                    <tr>
                        <td>Name</td>
            ...
            <div className="patient-visit-card-button-container">
                <button className="patientvisit-button" onClick={handleBack}>
                    {isExpanded ? "Back" : "Details"}
                </button>
                {isExpanded && (
                    <>
                        <button className="patient-visit-card-button" onClick={() => setIsEditing(!isEditing)}>
